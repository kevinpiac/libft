...
\
		ft_strlen.c ft_strlcat.c ft_strcmp.c ft_strncmp.c ft_strdup.c ft_strstr.c ft_strnstr.c ft_strcpy.c ft_strncpy.c ft_striter.c ft_striteri.c ft_strchr.c ft_strrchr.c ft_strjoin.c ft_strtrim.c ft_strsub.c \
\
