...
#    Updated: 2016/02/26 14:09:13 by kpiacent         ###   ########.fr        #
#                                                                              #
#******************************************************************************#
...
\
		ft_islower.c ft_isupper.c ft_isaplha.c ft_isdigit.c ft_isalnum.c ft_isprint.c ft_isascii.c ft_isspace.c ft_strequ.c\
\
