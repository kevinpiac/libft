...
\
	...
	ft_lstadd.c ft_lstiter.c ft_lstmap.c ft_lstput.c ft_lstputendl.c ft_lstaddback.c \
\
	ft_bitprint.c ft_bitgetfour.c ft_bitsetfour.c ft_bitgetoctal.c ft_bitsetoctal.c
